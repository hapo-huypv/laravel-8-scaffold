<div class="show-detail-course">
    ...
    <div class="d-flex align-items-center program">
        ...
        <a href="{{ route('courses.lessons.programs.show', ['course' => $course, 'lesson' => $lesson, 'program' => $program]) }}" id="btnPreviewLesson" class="col-2 flex-end btn btn-success btn-course-join-lesson p-0" type="submit">Preview</a>
    </div>
    <hr>
    @endforeach
</div>
