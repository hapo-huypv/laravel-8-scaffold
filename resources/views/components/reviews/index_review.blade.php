            ...
            @foreach ($course->number_count_rate as $key => $rating)
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-9 p-0 mr-1 progress progress-setup">
                        <div class="progress-bar" role="progressbar" style="width: {{ ($course->count_rate > config('app.none')) ? $rating / $course->count_rate * config('app.hundred') : config('app.none')}}%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
